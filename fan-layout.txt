...
[FAN4 exh] [FAN4 exh] [unused]             ← top exhaust
[FAN4 exh] [CPU FAN1]          [FAN2 in]   ← cpu level
           [slim FANA]         [FAN3 in]   ←
           [slim FANA]         [FAN3 in]   ←
           [slim FANA]                     ← bottom
```
...
| Header | Fans | Location                       |
|--------|------|--------------------------------|
| FAN1   | 1x   | CPU cooler                     |
| FAN2   | 1x   | front-top intake               |
| FAN3   | 2x   | front-bottom intake            |
| FAN4   | 3x   | all rear exhaust (top 2 + CPU) |
| FANA   | 3x   | slims over GPUs/RAM            |
...
### FAN2-4:
  - (2:Top Exhaust, 3:Front Intake, 4:Rear Exhaust)
  - ARCTIC P14 Pro PST
